...
import { resetPasswordThunk } from "../../feature/password/services/password.thunk"
      ...
      <div className="w-full max-w-md bg-white border border-gray-100 rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden z-10 relative flex flex-col">
        ...
        <div className="p-8 sm:p-10 flex flex-col">
          ...
          <div className="text-left space-y-1 mb-8">
            <h1 className="text-xl font-medium text-black">Nouveau mot de passe</h1>
            <p className="text-sm text-gray-400 font-semibold">Définissez vos nouvelles informations de connexion hautement sécurisées.</p>
          </div>
          ...
          {(error || localError) && (
            <div className="bg-rose-50 border border-rose-100 rounded-2xl p-4 flex items-start gap-3 mb-6">
              ...
              <div className="text-sm font-medium text-rose-700 text-left leading-relaxed">{localError || error}</div>
            </div>
          )}
          ...
          {successMessage && (
            <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 flex items-start gap-3 mb-6">
              ...
              <div className="text-sm font-medium text-emerald-700 text-left leading-relaxed">{successMessage}</div>
            </div>
          )}
          ...
          {!successMessage ? (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-blue-400 text-white rounded-xl py-3.5 font-medium text-sm shadow-sm transition-all duration-200 flex items-center justify-center gap-2"
              >
            ...
            <button
              ...
              className="w-full bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl py-3.5 font-medium text-sm shadow-sm transition-all duration-200 flex items-center justify-center"
            >
