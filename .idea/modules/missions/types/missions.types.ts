...
export interface Mission {
    ...
    latitude?: number;
    longitude?: number;
    // Phase 1 — Champs de gestion de projet
    reportId?: string;          // Signalement à l'origine de la mission
    dueDate?: string;           // Date limite d'exécution
    estimatedHours?: number;    // Durée estimée
    actualHours?: number;       // Durée réelle
    isOverdue?: boolean;        // Calculé côté backend
}
