    ...
    constructor(loginService) {
        ...
        this.login = async (req, res, next) => {
            try {
                ...
                const validatedData = login_validations_1.loginSchema.parse(req.body);
                // 2. Appel au service métier pour authentification
                const { user, accessToken, refreshToken } = await this.loginService.login(validatedData.identifier, validatedData.password);
