...
describe('TeamRepository', () => {
    ...
    beforeEach(() => {
        ...
        repository = new team_repository_1.TeamRepository(mockDb, mockLogger);
    });
    describe('createTeam', () => {
        it('should insert a new team and return the result', async () => {
            ...
            expect(mockDb.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO field_teams'), expect.arrayContaining([teamData.name, teamData.organizationId]));
    ...
    describe('logAttendance', () => {
        it('should call ST_Point with correct coordinates', async () => {
            ...
            expect(mockDb.query).toHaveBeenCalledWith(expect.stringContaining('ST_Point($4, $5)'), [expect.any(String), 'u1', 't1', 2.4, 6.3]);
        });
    });
});
