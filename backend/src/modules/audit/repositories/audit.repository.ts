...
import type { AuditLog, AuditFilters, PaginatedAuditResponse } from '../types/audit.types';
...
export class AuditRepository {
    ...
    async getAll(filters: AuditFilters, page: number, limit: number): Promise<PaginatedAuditResponse> {
        try {
            ...
            if (filters.tableName) { conditions.push(`table_name = $${idx++}`); params.push(filters.tableName); }
