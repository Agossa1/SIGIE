...
exports.FieldOpsRepository = void 0;
...
class FieldOpsRepository {
        ...
        try {
            ...
            const insertReportSql = `
                ...
                SELECT 
                    ...
                    $6, $7, $8, 
                    $9, loc.geom,
                    COALESCE($12, terr.n_id), terr.d_id, terr.m_id, terr.r_id
            ...
            const reportResult = await client.query(insertReportSql, [
                ...
                dto.createdBy, dto.infrastructureId, dto.mappedAreaId, dto.photoBase64,
    ...
    /**
     * Récupère tous les rapports avec des JOIN vers les tables filles.
     */
    async getReports() {
        try {
            const sql = `
                SELECT 
                    ...
                    tr.photo_base64 as "photoBase64",
...
exports.FieldOpsRepository = FieldOpsRepository;
//# sourceMappingURL=field-ops.repositories.js.map