...
import { selectPasswordLoading, selectPasswordError } from "../../feature/password/services/password.selectors"
import { clearPasswordState } from "../../feature/password/services/password.slice"
import { verifyCodePasswordOTPThunk } from "../../feature/password/services/password.thunk"
...
const VerifyCodePage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    e.preventDefault()
     try {
        //1.Rénitialisation des erreurs
        dispatch(clearPasswordState())
        await dispatch(verifyCodePasswordOTPThunk({email, otp})).unwrap()
        // 2. Navigation vers la page de réinitialisation en transmettant email + OTP
